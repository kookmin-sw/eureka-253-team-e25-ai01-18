...
- 멘토링 ✔️  
  - 내 지도 교수 함게 만나기
    **<느낀점>**
    -조은서 : 오늘 교수님과 상담을 통해 많은것을 알았는데 제일 놀라운건 C++이 중요할줄알았는데 대부분이 python으로 구동되는것이고  주로 연구를 python으로 한다고 하셔서 놀라웠다. 앞으로 python을 좀더 집중적으로 공부해야겠다는걸 느꼈다. 뿐만 아니라 안공지능 동아리 AIM 에서 파이토치로 머신러닝 사용법을 배우고있는데 처음 접하는거라 난해하고 어려웠지만 학부 연구생을 듣고싶고, 앞으로 나의 미래를 위해서도 방학때 공부하고 3학년때 꼭 학부 연구생이나 UROP를 하기로 결심했다. 관심이 있어서 김장호 교수님의 저번학기에 학부 연구생을 보니 ML/DL 관련 연구와 자동차, 포스코 쪽 관련을 많이 하시는 거 같았다. 그래서 지금 그런 모집 공고를 보면서 내가 공부해야할건 뭔지 갈피를 잡아서 이번 지도 교수님과의 상담이 도움이 되었다. 뿐만아니라 내 진로에 관해서 필요한게 뭔지, 필요없는게 뭔지 알 수 있었다. 왜냐하면 경제학개론, 회계학원론을 공대생이라도 들어야하나 고민이 있었는데 교수님께서 개발자들은 전공 수업을 챙기기도 바쁜데 다른건 자기 의견이지만 굳이 필요하지 않다고 말씀해주셨다. 따라서 이번 진로상담을 통해서 정말 궁금한 것, 도움되는것을 많이 물어봐서 좋았다. 
